<?php
require_once("simple_rest.php");
require_once("../model/msm_messages.php");
		
class MessagesController extends SimpleRest {
	...
	function getAllMessages() {
		...
		$rawData = $messages->getAllMessages();
	...
	public function getMessage($id) {
		$messages = new MSMMessages();
		$rawData = $messages->getMessage($id);
